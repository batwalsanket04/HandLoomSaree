  ...
  return (
    <section
      className="relative w-[90%] rounded-3xl py-16 px-4 sm:px-6 mt-[80px] 
                 h-[50vh] sm:h-[60vh] md:h-[70vh] my-[30px] mx-auto text-left md:mt-[100px]  
                lg:h-[80vh] bg-no-repeat bg-center bg-cover bg-blend-overlay lg:mt-[80px]"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start gap-3 sm:gap-6 md:gap-[1.5vw] 
        ...
        <h1 className="text-2xl  sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl xl:mt-20 font-extrabold text-pink-600 drop-shadow-lg 
              2xl:text-xl w-full ">
